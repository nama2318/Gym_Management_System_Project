...
p1=new JPanel();
			...
			TitledBorder a=new TitledBorder(new LineBorder(Color.white, 2), "-     Equipment Details     -", TitledBorder.LEADING,TitledBorder.TOP,null,new Color(130,0,250));
...
public void actionPerformed(ActionEvent ae)
          {
			...
			if(s.equals("Delete"))
			{
			      ...
			      int b;
					...
					PreparedStatement ps=co.prepareStatement("delete from ei where Id=?");
...
if(ae.getSource()==b11)
	...
	try{
				...
				String Co[]={"ID","Equipment_Name","Quantity","Vendor_name","Date","Price"};
