   ...
   Font f1=new Font("Times New Roman",Font.BOLD,15);
	public Tt()
	{
	  ...
	  //	Font f2=new Font("Lucida Calligraphy",Font.Bold,20);
			...
			TitledBorder a=new TitledBorder(new LineBorder(Color.white, 2), "-     Trainer Details     -", TitledBorder.LEADING,TitledBorder.TOP,null,new Color(130,0,250));
...
if(ae.getSource()==b11)
	...
	try{
			Class.forName("com.mysql.jdbc.Driver");
				...
				String Co[]={"ID","UserName","Contact","Address","DOB","Age","BloodGroup"};
