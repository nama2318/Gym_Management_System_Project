...
public class reg extends JFrame implements ActionListener
{
	...
	public reg()
	{
		...
		Font f1=new Font("Times New Roman",Font.BOLD,20);
	  	//Font f1=new Font("Lucida Calligraphy",Font.Bold,20);
			...
			TitledBorder a=new TitledBorder(new LineBorder(Color.white, 2), "Customer Registration", TitledBorder.LEADING,TitledBorder.TOP,null,new Color(255,165,0));
       ...
       // t2.setFont(new Font("Times New Roman",Font.BOLD,20));
        ...
        t13.setFont(new Font("Times New Roman",Font.BOLD,20)); 
        ...
        l11.setBounds(50,340,150,50);
        l12.setBounds(350,340,200,50);
        l13.setBounds(630,340,100,50);
        l14.setBounds(50,400,150,50);

    	
        b12.setBounds(660,500,100,50);
        b13.setBounds(220,500,100,50);

        t1.setBounds(150,110,200,35);
      ...
      //  t3.setBounds(870,110,200,35);
        ...
        t10.setBounds(180,350,150,35);
        t11.setBounds(430,350,150,35);
        t12.setBounds(750,350,150,35);
        t13.setBounds(180,410,150,35);
	...
	b4= new JButton("",new ImageIcon("m.jpg"));
	b4.setBounds(5,30,60,55);
	p1.add(b4);
 ...
 public void actionPerformed(ActionEvent ae)
          {
			...
			if(s.equals("Submit"))
			{
			      ...
			      String a,b,c,d,e,f,g,h,i,j,k,l,q;
					...
					PreparedStatement ps=co.prepareStatement("insert into cust(Fn,Ln,Mn,ad,dob,age,bg,ht,wt,bt,pk,pr) values(?,?,?,?,?,?,?,?,?,?,?,?)");
